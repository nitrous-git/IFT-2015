...
public class SinglyLinkedList<E> implements List<E> {
    ...
    public void add( int index, E element ) throws IndexOutOfBoundsException { // add element at index i in O(n) // est utiliser par CircularlyLinkedList
    ...
    // algo de reverse recursif en O(n) aussi 
    ...
    // algo de reverse non recursif en O(n)
    public void reverse() { // iterative version
		...
		// a la fin, on replace tail = head et previous (qui est le dernier) a head 
		this.tail = this.head;
		this.head = previous;
    }
}
